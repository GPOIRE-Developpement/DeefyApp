-- Schéma de base de données pour DeefyApp
-- Créer la base de données si elle n'existe pas
CREATE DATABASE IF NOT EXISTS deefyapp CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE deefyapp;
...
-- Données de test pour les playlists
...
-- Mots de passe : user1, user2, user3, user4, admin (tous hashés avec bcrypt cost=12)
...
-- Table de liaison user-playlist (propriétaires)
...
-- Attribution des playlists aux utilisateurs
